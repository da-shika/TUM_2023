    ...
    def process_epoch(self, data, training=True):
        ...
        for n_batch, (
            ...
            (y_left_img, y_right_img, y_left_pose, y_right_pose, \
             y_left_force, y_right_force, y_left_proximity, y_right_proximity)) in enumerate(data):
            ...
            for t in range(T - 1):
                ...
                _yi_hat, _ypose_hat, _yf_hat, _yp_hat, enc_ij, dec_ij, state = self.model(
                    x_img, x_pose, x_force, x_proximity, state
                )
