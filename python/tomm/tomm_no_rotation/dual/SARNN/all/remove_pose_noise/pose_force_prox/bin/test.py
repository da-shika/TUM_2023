...
# load dataset
detaset_folder = "/home/genki/ros/workspaces/tomm_base_ws_local/bags/pick_no_rotate/data/dual/all/remove_pose_noise" + "/"
...
for loop_ct in range(nloop):
    ...
    # predict rnn
    y_image, y_pose, y_force, y_proximity, ect_pts, dec_pts, state =\
        model(img_t, pose_t, force_t, proximity_t, state)
