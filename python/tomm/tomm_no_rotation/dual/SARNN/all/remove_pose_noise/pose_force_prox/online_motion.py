...
#-----------------------------------------------------------------------------------------------------------------------------------------
    def inference(self, state):
        ...
        x_proximity = [self.process_prox(self.left_proximity, self.left_proximity_bounds),
                       self.process_prox(self.right_proximity, self.right_proximity_bounds)]
