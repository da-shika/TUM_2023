...
class MultimodalDataset(Dataset):
    ...
    def __init__(self, left_images, right_images, left_poses, right_poses, left_proximitys, right_proximitys, stdev=None):
        """
    ...
    def __getitem__(self, idx):
        ...
        return [[x_left_img, x_right_img, x_left_pose, x_right_pose, x_left_proximity, x_right_proximity],
                [y_left_img, y_right_img, y_left_pose, y_right_pose, y_left_proximity, y_right_proximity]]
