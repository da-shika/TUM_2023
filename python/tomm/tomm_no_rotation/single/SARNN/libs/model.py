...
class SARNN(nn.Module):
    ...
    def __init__(
        ...
        rec_in = self.pose_dim + self.prox_dim + self.k_dim*2
    ...
    def forward(self, xi, xpose, xprox, state=None):
        """
        ...
        hid = torch.cat([enc_pts, xpose, xprox], -1)
        ...
        return y_image, y_pose, y_prox, enc_pts, dec_pts, rnn_hid