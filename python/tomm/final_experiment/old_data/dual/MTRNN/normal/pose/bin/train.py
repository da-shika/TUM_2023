...
# train data
left_image, left_poses = load_data(train='train', data_type='left')
right_image, right_poses = load_data(train='train', data_type='right')
train_dataset = MultimodalDataset(left_image, right_image, left_poses, right_poses, stdev=stdev)
...
# test data
left_image, left_poses = load_data(train='test', data_type='left')
right_image, right_poses = load_data(train='test', data_type='right')
test_dataset = MultimodalDataset(left_image, right_image, left_poses, right_poses, stdev=None)
