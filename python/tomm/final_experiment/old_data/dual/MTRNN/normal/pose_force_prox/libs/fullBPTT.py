    ...
    def process_epoch(self, data, training=True):
        ...
        for n_batch, (
            ...
            for t in range(T - 1):
                ...
                _yi_hat, _ypose_hat, _yf_hat, _yp_hat, enc_ij, dec_ij, state, _ = self.model(x_img, x_pose, x_force, x_proximity, state)
            ...
            left_pt_loss = nn.MSELoss()(left_enc_pts, left_dec_pts) * self.scheduler(self.loss_weights[2])
            right_pt_loss = nn.MSELoss()(right_enc_pts, right_dec_pts) * self.scheduler(self.loss_weights[2])
