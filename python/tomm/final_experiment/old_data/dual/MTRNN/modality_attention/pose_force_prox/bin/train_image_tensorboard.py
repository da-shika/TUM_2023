...
with tqdm(range(args.epoch)) as pbar_epoch:
    for epoch in pbar_epoch:
        ...
        if epochs_counter % 20 == 0 and epochs_counter < 201:
            with torch.no_grad():
                model.to("cpu")
                model.eval()
                ...
                def write_gif(log_dir_path, save_name, image_list, title):
                ...
                write_gif(log_dir_path, "left_image_{}.gif".format(epochs_counter), left_image_list, "Left Image")
                write_gif(log_dir_path, "right_image_{}.gif".format(epochs_counter), right_image_list, "Right Image")
