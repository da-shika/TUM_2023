...
class fullBPTTtrainer:
    ...
    def process_epoch(self, data, training=True):
        ...
        total_loss = 0.0
        for n_batch, (
            (x_left_img, x_right_img, x_left_pose, x_right_pose, x_left_proximity, x_right_proximity),
            (y_left_img, y_right_img, y_left_pose, y_right_pose, y_left_proximity, y_right_proximity)) in enumerate(data):
            ...
            for t in range(T - 1):
                ...
                _yi_hat, _ypose_hat, _yp_hat, enc_ij, dec_ij, state = self.model(x_img, x_pose, x_proximity, state)
