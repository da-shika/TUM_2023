...
#-----------------------------------------------------------------------------------------------------------------------------------------
    def inference(self, state):
        ...
        with torch.no_grad():
            y_image, y_pose, y_force, y_proximity, enc_pts, dec_pts, state = self.model(x_image, x_pose, x_force, x_proximity, state)
...
def main():
    ...
    SARNN_motion = OnlineSARNN(
        data_dir="./log/k_dim_5/pt_loss_0.05/im_decay_1000/f_decay_400", 
        model_name="20231206_1309_16", 
        inference_rate=10,
