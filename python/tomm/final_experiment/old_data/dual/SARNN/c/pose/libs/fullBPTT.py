...
class fullBPTTtrainer:
    ...
    def __init__(self, model, optimizer, loss_weights=[1.0, 1.0], device="cpu"):
        ...
        self.image_scheduler = LossScheduler(decay_end=1000, curve_name="s")
    ...
    def process_epoch(self, data, training=True):
        ...
        total_loss = 0.0
        for n_batch, (
            (x_left_img, x_right_img, x_left_pose, x_right_pose),
            (y_left_img, y_right_img, y_left_pose, y_right_pose)) in enumerate(data):
            ...
            for t in range(T - 1):
                ...
                _yi_hat, _ypose_hat, enc_ij, dec_ij, state = self.model(x_img, x_pose, state)
