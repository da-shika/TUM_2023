...
class HLSTMLayer(nn.Module):
    ...
    def forward(self, xl, xr, state=[None, None, None]):
        ...
        union_input = torch.concat((left_hid[1], right_hid[1]), axis=-1)
        ...
        union_left = [left_hid[0], _union_left]
        union_right = [right_hid[0], _union_right]
...
class SARNN(nn.Module):
    ...
    def forward(self, xi, xpos, xf, xp, epoch, image_stop_epoch, state=[None,None,None]):
        """
