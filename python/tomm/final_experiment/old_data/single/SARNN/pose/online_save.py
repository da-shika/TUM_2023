...
#-----------------------------------------------------------------------------------------------------------------------------------------
    def run(self):
        ...
        while not rospy.is_shutdown() and self.steps < self.max_episode_steps:
            y_image, y_left_pose, y_right_pose, enc_pts, dec_pts, state = self.inference(state)
            ...
            self.append_params(y_image, y_left_pose, y_right_pose, enc_pts, dec_pts, state)
...
#-----------------------------------------------------------------------------------------------------------------------------------------
    def inference(self, state):
        ...
        return y_image, y_left_pose, y_right_pose, enc_pts, dec_pts, state
    ...
    def append_params(self, y_image, y_left_pose, y_right_pose, enc_pts, dec_pts, state):
