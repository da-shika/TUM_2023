...
cd /home/shikada/python/TUM/final_experiments/old_data/dual/SARNN/ch/pose
python3 bin/train.py --CUDA_VISIBLE_DEVICES $CUDA_VISIBLE_DEVICES

cd /home/shikada/python/TUM/final_experiments/old_data/dual/MTRNN/normal/pose
python3 bin/train.py --CUDA_VISIBLE_DEVICES $CUDA_VISIBLE_DEVICES

cd /home/shikada/python/TUM/final_experiments/old_data/single/SARNN/pose