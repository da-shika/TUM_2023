...
detaset_folder = "/home/shikada/dataset/TUM/tomm_tutorial/dual/"
...
def load_data(train='train', data_type='left'):
    ...
    return images, joints, poses, proximities


# load train data
left_image, left_joint, left_poses, left_proximity = load_data(train='train', data_type='left')
right_image, right_joint, right_poses, right_proximity = load_data(train='train', data_type='right')
train_dataset = MultimodalAllDataset(left_image, right_image, left_joint, right_joint, left_poses, right_poses, \
                                    left_proximity, right_proximity, stdev=stdev, training=True)
...
# load test data
left_image, left_joint, left_poses, left_proximity = load_data(train='test', data_type='left')
right_image, right_joint, right_poses, right_proximity = load_data(train='test', data_type='right')
test_dataset = MultimodalAllDataset(left_image, right_image, left_joint, right_joint, left_poses, right_poses, \
                                    left_proximity, right_proximity, stdev=0.0, training=False)
