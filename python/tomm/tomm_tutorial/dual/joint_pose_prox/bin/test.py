...
# load dataset
left_image, left_joint, left_pose, left_proximity = load_data(train='test', data_type='left')
right_image, right_joint, right_pose, right_proximity = load_data(train='test', data_type='right')
...
# Inference
img_size = 64
image_list, joint_list, pose_list, proximity_list = [], [], [], []
...
for loop_ct in range(nloop):
    ...
    # predict rnn
    y_image, y_joint, y_pose, y_proximity, ect_pts, dec_pts, state = model(img_t, joint_t, pose_t, proximity_t, state)
