...
train_dataset = MultimodalAllDataset(left_image, right_image, left_poses, right_poses, stdev=stdev, training=True)
...
test_dataset = MultimodalAllDataset(left_image, right_image, left_poses, right_poses, stdev=0.0, training=False)
