...
train_dataset = MultimodalAllDataset(left_image, right_image, left_poses, right_poses, \
...
test_dataset = MultimodalAllDataset(left_image, right_image, left_poses, right_poses, \
