...
# load train data
left_image, left_joint = load_data(train='train', data_type='left')
right_image, right_joint = load_data(train='train', data_type='right')
train_dataset = MultimodalAllDataset(left_image, right_image, left_joint, right_joint, stdev=stdev, training=True)
...
# load test data
left_image, left_joint = load_data(train='test', data_type='left')
right_image, right_joint = load_data(train='test', data_type='right')
test_dataset = MultimodalAllDataset(left_image, right_image, left_joint, right_joint, stdev=0.0, training=False)
