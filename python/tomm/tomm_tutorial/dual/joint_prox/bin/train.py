...
# load train data
left_image, left_joint, left_proximity = load_data(train='train', data_type='left')
right_image, right_joint, right_proximity = load_data(train='train', data_type='right')
train_dataset = MultimodalAllDataset(left_image, right_image, left_joint, right_joint, \
...
test_dataset = MultimodalAllDataset(left_image, right_image, left_joint, right_joint, \
