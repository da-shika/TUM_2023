...
class MultimodalAllDataset(Dataset):
    ...
    def __init__(self, left_image, right_image, left_joint, right_joint, \
                 left_proximity, right_proximity, stdev=0.0, training=True):
        """
    ...
    def __getitem__(self, idx):
        ...
        return [[x_left_img, x_right_img, x_left_joint, x_right_joint, \
                 x_left_proximity, x_right_proximity],
                [y_left_img, y_right_img, y_left_joint, y_right_joint,\
