...
parser.add_argument("--state_loss", type=float, default=0.1)
...
images = np.load("../data/SII/train/images.npy")
images = resize_img(images, (64, 64))
images = images.transpose(0, 1, 4, 2, 3)
images = normalization(images, (0, 255), minmax)
joints = np.load("../data/SII/train/joints.npy")
joint_bounds = np.load("../data/SII/train/ja_bounds.npy")
...
images = np.load("../data/SII/test/images.npy")
images = resize_img(images, (64, 64))
images = images.transpose(0, 1, 4, 2, 3)
images = normalization(images, (0, 255), minmax)
joints = np.load("../data/SII/test/joints.npy")
joints = normalization(joints, joint_bounds, minmax)
...
loss_weights = [args.img_loss, args.joint_loss, args.pt_loss, args.state_loss]
