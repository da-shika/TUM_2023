...
# load dataset
detaset_folder = "/home/genki/ros/workspaces/tomm_base_ws_local/bags/pick_no_rotate/data/single/remove_pose_noise/"
...
# Inference
img_size = 64
image_list, pose_list, prox_list = [], [], []
...
for loop_ct in range(nloop):
    ...
    # predict rnn
    y_image, y_pose, y_prox, ect_pts, dec_pts, state = model(img_t, pose_t, prox_t, state)
...
def anim_update(i):
    ...
    plot_data(left_proximity, left_proximity_bounds, right_proximity, right_proximity_bounds, pred_prox, ax[1,1], (0.0, 1.0), "Proximity")
