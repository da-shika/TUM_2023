...
# load dataset
detaset_folder = "/home/shikada/dataset/TUM/re_no_rotate/"
        ...
        if epochs_counter % 50 == 0:
            with torch.no_grad():
                ...
                for step in range(20):
                    ...
                    force = [test_dataset[0][0][4][step].unsqueeze(0), test_dataset[0][0][5][step].unsqueeze(0)]
                    prox = [test_dataset[0][0][6][step].unsqueeze(0), test_dataset[0][0][7][step].unsqueeze(0)]
                    y_image, _, _, _, enc_pts, dec_pts, state, _ = model(image, pose, force, prox, state)
