...
def anim_update(i):
    ...
    plot_attention(left_att_enc, left_att_force, left_att_prox, ax[1,3], (0.0, 1.0), "Left")
    plot_attention(right_att_enc, right_att_force, right_att_prox, ax[1,4], (0.0, 1.0), "Right")
