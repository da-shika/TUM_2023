...
def main():
    npz_root_dir = "/home/genki/ros/workspaces/tomm_base_ws_local/bags/final_experiment/npz/single"
    ...
    images, left_joints, right_joints, left_poses, right_poses, left_forces_raw, right_forces_raw, left_proximities_raw, right_proximities_raw = load_data(npz_root_dir)
    ...
    root_dir = "/home/genki/ros/workspaces/tomm_base_ws_local/bags/final_experiment/data/single"
