...
parser.add_argument("--idx", type=int, default=9)
...
left_forces = np.load(root_dir + "test/left_forces_raw.npy")
right_forces = np.load(root_dir + "test/right_forces_raw.npy")
left_force_bounds = np.load(root_dir + "left_force_bounds_raw.npy")
right_force_bounds = np.load(root_dir + "right_force_bounds_raw.npy")
...
def anim_update(i):
    ...
    plot_data(ax[1,5], (0.0, 1.0), right_forces, 'Right Forces')
