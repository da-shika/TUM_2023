...
if __name__ == "__main__":
    ...
    def saver(mode, mode_list):
        ...
        np.save(root_dir + "/data/dual/"+ mode +"/left_forces.npy", left_forces[mode_list].astype(np.float32))
        ...
        np.save(root_dir + "/data/dual/"+ mode +"/right_forces.npy", right_forces[mode_list].astype(np.float32))
    ...
    np.save(root_dir + "/data/dual/left_force_bounds.npy", left_force_bounds)
    np.save(root_dir + "/data/dual/right_force_bounds.npy", right_force_bounds)
