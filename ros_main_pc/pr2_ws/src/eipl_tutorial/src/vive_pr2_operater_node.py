...
class VivePR2Controller:
    ...
    def config_marix(self):
        ...
        q_right_wrist_to_base = np.array([0.03981, -0.074568, -0.022653, 0.99616])
...
#-------------------------------------------------------------------------------------------------------------------
    ...
    def send_record_cmd(self):
        rosbag_start_cmd = "rosbag record -O eipl_tutorial_"+str(self.record_loop)+".bag /joint_states /r_arm_controller/command /pr2_left_gripper_cmd /pr2_right_gripper_cmd /camera/rgb/image_compressed"
