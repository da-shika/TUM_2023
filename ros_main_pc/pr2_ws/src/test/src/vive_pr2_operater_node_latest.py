...
#-------------------------------------------------------------------------------------------------------------------
    ...
    def update_relative_position(self):
        ...
        _vive_left_relative_pos = get_vive_relative_pos(self.vive_left_current_pos, self.vive_left_reference_pos)
        _vive_right_relative_pos = get_vive_relative_pos(self.vive_right_current_pos, self.vive_right_reference_pos)
        
        # smoothing
        self.vive_left_relative_pos = self.smoothing(self.vive_left_relative_pos, _vive_left_relative_pos)
        self.vive_right_relative_pos = self.smoothing(self.vive_right_relative_pos, _vive_right_relative_pos)
...
#-------------------------------------------------------------------------------------------------------------------
    ...
    def smoothing(self, smooth_cmd, real_cmd):
