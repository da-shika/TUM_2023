...
#-------------------------------------------------------------------------------
    ...
    def publish(self):
        self.left_trajectory = create_joint_trajectory(self.left_arm_name, self.controll_freq)
        self.right_trajectory = create_joint_trajectory(self.right_arm_name, self.controll_freq)
