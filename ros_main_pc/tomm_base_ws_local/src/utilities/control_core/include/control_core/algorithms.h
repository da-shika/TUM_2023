...
#include <control_core/algorithms/scalar_leaky_integrator.h>
#include <control_core/algorithms/scalar_fir_filter.h>
#include <control_core/algorithms/quaternion_filter.h>
...
namespace cc
{
  ...
  typedef control_core::ScalarFIRFilter<cc::Scalar> 
    ScalarFIRFilter;

  typedef control_core::ScalarExponentialDecayFilter<cc::Scalar> 
    ScalarExponentialDecayFilter;

  typedef control_core::ScalarLeakyIntegrator<cc::Scalar> 
    ScalarLeakyIntegrator;

  typedef control_core::QuaternionFilter<cc::Scalar> 
    QuaternionFilter;
