 ...
 */
class JointStateSpline5 : public control_core::StateTrajectory<cc::JointState>
{
public:
  typedef control_core::StateTrajectory<cc::JointState> Base;

public:
  JointStateSpline5(cc::Scalar period, const cc::JointPosition& q_start, const cc::JointPosition& q_end, int size=Eigen::Dynamic) :
 ...
 * @brief A fith order (minimal jerk) trajectory in jointspace
 */
class JointStateSpline6 : public control_core::StateTrajectory<cc::JointState>
{
public:
  typedef control_core::StateTrajectory<cc::JointState> Base;

public:
  JointStateSpline6(cc::Scalar period, const cc::JointPosition& q_start, const cc::JointPosition& q_end, const cc::JointPosition& q_middle, int size=Eigen::Dynamic) :
    Base(control_core::Polynomial6Order<cc::JointPosition>(period, 
      q_start, cc::JointPosition::Zero(q_start.size()), cc::JointPosition::Zero(q_start.size()),
      q_end, cc::JointPosition::Zero(q_start.size()), cc::JointPosition::Zero(q_start.size()), q_middle)) {}
};
...
public:
   ...
   * @brief Deconstructor.
   */
  virtual ~AngularStateSlerpTrajectory()
  {
  }
