#ifndef ICS_TSID_TASKS_invdyn_task_contact_force_constraint_hard_hpp__
#define ICS_TSID_TASKS_invdyn_task_contact_force_constraint_hard_hpp__
...
namespace tsid
{
  namespace tasks
  {
    ...
    /**
     * @brief TaskContactForceConstraintHard
     * 
     ...
     */
    class TaskContactForceConstraintHard : public TaskMotion
    {
    public:
    ...
    public:
      TaskContactForceConstraintHard(const std::string & name,
                         cc::Scalar dt,
