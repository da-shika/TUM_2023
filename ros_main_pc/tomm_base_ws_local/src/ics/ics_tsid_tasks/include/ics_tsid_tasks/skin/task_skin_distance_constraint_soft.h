#ifndef ICS_TSID_TASKS_invdyn_task_skin_distance_constraint_soft_hpp__
#define ICS_TSID_TASKS_invdyn_task_skin_distance_constraint_soft_hpp__
...
namespace tsid
{
  namespace tasks
  {
    ...
    /**
     * @brief TaskSkinDistanceMotion a sub task used by TaskSkinDistanceConstraint
     * 
     * This task is added on top of TaskSkinDistanceConstraint to add an 
     * additional repulsive for component to the formulation.
     */
    class TaskSkinDistanceMotion : public TaskMotion
    {
      public:
      ...
      public:
        TaskSkinDistanceMotion(const std::string & name,
                              RobotWrapper & robot);
    ...
    /**
     * @brief TaskSkinDistanceConstraintSoft
     * 
     ...
     */
    class TaskSkinDistanceConstraintSoft : public TaskMotion
    {
    public:
      typedef TaskMotion Base;
      typedef std::shared_ptr<TaskSkinDistanceMotion> MotionTask;
    ...
    public:
      TaskSkinDistanceConstraintSoft(const std::string & name,
                         cc::Scalar dt,
    ...
    protected:
      ...
      std::vector<double> distances_lp_;
