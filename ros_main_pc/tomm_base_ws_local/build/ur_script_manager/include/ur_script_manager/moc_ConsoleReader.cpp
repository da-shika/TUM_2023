...
#include "../../../../src/tomm-robot/ur_script_manager/include/ur_script_manager/ConsoleReader.h"
...
QT_MOC_LITERAL(4, 25, 4) // "text"

    },
    "ConsoleReader\0message\0\0s\0text"
};
...
void ConsoleReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ConsoleReader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ConsoleReader::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ConsoleReader::message)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ConsoleReader::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ConsoleReader.data,
    qt_meta_data_ConsoleReader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ConsoleReader::message(QString _t1)
{
