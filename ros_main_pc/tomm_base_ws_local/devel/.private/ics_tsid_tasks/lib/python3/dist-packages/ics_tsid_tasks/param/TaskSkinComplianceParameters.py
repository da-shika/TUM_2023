...
param_description = [{'name': 'kp', 'type': 'cc::VectorX', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 1000, 'is_vector': False, 'is_eigen': True, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False}, {'name': 'kd', 'type': 'cc::VectorX', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 1000, 'is_vector': False, 'is_eigen': True, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False}, {'name': 'kp_factor', 'type': 'double', 'default': 1.0, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 5.0, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'kd_factor', 'type': 'double', 'default': 1.0, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 5.0, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'alpha_proximity', 'type': 'double', 'default': 0.5, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 1.0, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'fd_normal', 'type': 'double', 'default': 0.0, 'level': 0, 'edit_method': '""', 'description': '', 'min': -1.6, 'max': 1.5, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}]
...
class TaskSkinComplianceParameters(dict):
    def __init__(self):
