...
param_description = [{'name': 'masked_patches', 'type': 'std::vector<std::string>', 'default': [''], 'level': 0, 'edit_method': '""', 'description': '', 'min': None, 'max': None, 'is_vector': True, 'is_eigen': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False}, {'name': 'mass', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 1.0, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'gain', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 5.0, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'damp', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 100.0, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'f_max', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 5.0, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'f_min', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 5.0, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'a_max', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 10.0, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'alpha', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 0.999, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'kp', 'type': 'cc::VectorX', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 1000, 'is_vector': False, 'is_eigen': True, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False}]
...
class TaskSkinForceConstraintsParameters(dict):
    def __init__(self):
