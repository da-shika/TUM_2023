...
param_description = [{'name': 'masked_patches', 'type': 'std::vector<std::string>', 'default': [''], 'level': 0, 'edit_method': '""', 'description': '', 'min': None, 'max': None, 'is_vector': True, 'is_eigen': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False}, {'name': 'v_damp', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 0.5, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'v_max', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 0.5, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'd_min', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.01, 'max': 0.06, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'd_start', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.03, 'max': 0.1, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'alpha', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 0.999, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'kp', 'type': 'cc::VectorX', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': 0.0, 'max': 1000, 'is_vector': False, 'is_eigen': True, 'is_map': False, 'configurable': True, 'constant': False, 'global_scope': False}]
...
class TaskSkinDistanceConstraintsParameters(dict):
    def __init__(self):
