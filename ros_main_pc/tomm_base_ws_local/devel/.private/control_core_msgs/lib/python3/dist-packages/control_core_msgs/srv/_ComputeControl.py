...
"""autogenerated by genpy from control_core_msgs/ComputeControlRequest.msg. Do not edit."""
import codecs
import sys
...
class ComputeControlRequest(genpy.Message):
  _md5sum = "cc8060cad1db6edde9e175062a572328"
  _type = "control_core_msgs/ComputeControlRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """RobotState state    # current robot state
...
float32 y
float32 z"""
  __slots__ = ['state','do_stop']
  _slot_types = ['control_core_msgs/RobotState','uint8']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.do_stop,) = _get_struct_B().unpack(str[start:end])
      return self
...
def _get_struct_d():
    ...
    return _struct_d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from control_core_msgs/ComputeControlResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class ComputeControlResponse(genpy.Message):
  _md5sum = "e1d5e39018c55415d1bd96b8a2c1d90f"
  _type = "control_core_msgs/ComputeControlResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """JointState command  # current robot command
...
MSG: control_core_msgs/Vector
float64[] data"""
  __slots__ = ['command','do_stop']
  _slot_types = ['control_core_msgs/JointState','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.command is None:
        self.command = control_core_msgs.msg.JointState()
      if self.do_stop is None:
        self.do_stop = 0
    else:
      self.command = control_core_msgs.msg.JointState()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.command.position.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.command.position.data))
      length = len(self.command.velocity.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.command.velocity.data))
      length = len(self.command.acceleration.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.command.acceleration.data))
      _x = self.do_stop
      buff.write(_get_struct_B().pack(_x))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.command.position.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.command.velocity.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.command.acceleration.data = s.unpack(str[start:end])
      start = end
      end += 1
      (self.do_stop,) = _get_struct_B().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.command.position.data.tostring())
      length = len(self.command.velocity.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.command.velocity.data.tostring())
      length = len(self.command.acceleration.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.command.acceleration.data.tostring())
      _x = self.do_stop
      buff.write(_get_struct_B().pack(_x))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.command.position.data = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.command.velocity.data = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.command.acceleration.data = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 1
      (self.do_stop,) = _get_struct_B().unpack(str[start:end])
      return self
...
class ComputeControl(object):
  _type          = 'control_core_msgs/ComputeControl'
  _md5sum = '3f913e6ebf5507fa61207688a03bb51a'
