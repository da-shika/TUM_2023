...
"""autogenerated by genpy from control_core_msgs/RobotState.msg. Do not edit."""
import codecs
import sys
...
class RobotState(genpy.Message):
  _md5sum = "c93ef624511e3a3594ee3528444b88cf"
  _type = "control_core_msgs/RobotState"
...
float32 y
float32 z"""
  __slots__ = ['joints','floating_base','imu','ft_sensors','patches']
  _slot_types = ['control_core_msgs/JointState','control_core_msgs/CartesianState','sensor_msgs/Imu','geometry_msgs/WrenchStamped[]','control_core_msgs/SkinPatch[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       joints,floating_base,imu,ft_sensors,patches
    ...
    if args or kwds:
      ...
      if self.joints is None:
        self.joints = control_core_msgs.msg.JointState()
      if self.floating_base is None:
        self.floating_base = control_core_msgs.msg.CartesianState()
      if self.imu is None:
        self.imu = sensor_msgs.msg.Imu()
      if self.ft_sensors is None:
        self.ft_sensors = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.joints.position.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.joints.position.data))
      length = len(self.joints.velocity.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.joints.velocity.data))
      length = len(self.joints.acceleration.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.joints.acceleration.data))
      _x = self
      buff.write(_get_struct_19d3I().pack(_x.floating_base.position.position.x, _x.floating_base.position.position.y, _x.floating_base.position.position.z, _x.floating_base.position.orientation.x, _x.floating_base.position.orientation.y, _x.floating_base.position.orientation.z, _x.floating_base.position.orientation.w, _x.floating_base.velocity.linear.x, _x.floating_base.velocity.linear.y, _x.floating_base.velocity.linear.z, _x.floating_base.velocity.angular.x, _x.floating_base.velocity.angular.y, _x.floating_base.velocity.angular.z, _x.floating_base.acceleration.linear.x, _x.floating_base.acceleration.linear.y, _x.floating_base.acceleration.linear.z, _x.floating_base.acceleration.angular.x, _x.floating_base.acceleration.angular.y, _x.floating_base.acceleration.angular.z, _x.imu.header.seq, _x.imu.header.stamp.secs, _x.imu.header.stamp.nsecs))
      ...
      length = len(self.ft_sensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.ft_sensors:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joints.position.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.joints.velocity.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.joints.acceleration.data = s.unpack(str[start:end])
      _x = self
      start = end
      end += 164
      (_x.floating_base.position.position.x, _x.floating_base.position.position.y, _x.floating_base.position.position.z, _x.floating_base.position.orientation.x, _x.floating_base.position.orientation.y, _x.floating_base.position.orientation.z, _x.floating_base.position.orientation.w, _x.floating_base.velocity.linear.x, _x.floating_base.velocity.linear.y, _x.floating_base.velocity.linear.z, _x.floating_base.velocity.angular.x, _x.floating_base.velocity.angular.y, _x.floating_base.velocity.angular.z, _x.floating_base.acceleration.linear.x, _x.floating_base.acceleration.linear.y, _x.floating_base.acceleration.linear.z, _x.floating_base.acceleration.angular.x, _x.floating_base.acceleration.angular.y, _x.floating_base.acceleration.angular.z, _x.imu.header.seq, _x.imu.header.stamp.secs, _x.imu.header.stamp.nsecs,) = _get_struct_19d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.joints.position.data.tostring())
      length = len(self.joints.velocity.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.joints.velocity.data.tostring())
      length = len(self.joints.acceleration.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.joints.acceleration.data.tostring())
      _x = self
      buff.write(_get_struct_19d3I().pack(_x.floating_base.position.position.x, _x.floating_base.position.position.y, _x.floating_base.position.position.z, _x.floating_base.position.orientation.x, _x.floating_base.position.orientation.y, _x.floating_base.position.orientation.z, _x.floating_base.position.orientation.w, _x.floating_base.velocity.linear.x, _x.floating_base.velocity.linear.y, _x.floating_base.velocity.linear.z, _x.floating_base.velocity.angular.x, _x.floating_base.velocity.angular.y, _x.floating_base.velocity.angular.z, _x.floating_base.acceleration.linear.x, _x.floating_base.acceleration.linear.y, _x.floating_base.acceleration.linear.z, _x.floating_base.acceleration.angular.x, _x.floating_base.acceleration.angular.y, _x.floating_base.acceleration.angular.z, _x.imu.header.seq, _x.imu.header.stamp.secs, _x.imu.header.stamp.nsecs))
      _x = self.imu.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joints.position.data = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.joints.velocity.data = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.joints.acceleration.data = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 164
      (_x.floating_base.position.position.x, _x.floating_base.position.position.y, _x.floating_base.position.position.z, _x.floating_base.position.orientation.x, _x.floating_base.position.orientation.y, _x.floating_base.position.orientation.z, _x.floating_base.position.orientation.w, _x.floating_base.velocity.linear.x, _x.floating_base.velocity.linear.y, _x.floating_base.velocity.linear.z, _x.floating_base.velocity.angular.x, _x.floating_base.velocity.angular.y, _x.floating_base.velocity.angular.z, _x.floating_base.acceleration.linear.x, _x.floating_base.acceleration.linear.y, _x.floating_base.acceleration.linear.z, _x.floating_base.acceleration.angular.x, _x.floating_base.acceleration.angular.y, _x.floating_base.acceleration.angular.z, _x.imu.header.seq, _x.imu.header.stamp.secs, _x.imu.header.stamp.nsecs,) = _get_struct_19d3I().unpack(str[start:end])
