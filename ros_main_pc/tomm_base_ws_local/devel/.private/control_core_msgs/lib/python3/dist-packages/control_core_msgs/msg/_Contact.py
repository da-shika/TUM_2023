...
"""autogenerated by genpy from control_core_msgs/Contact.msg. Do not edit."""
import codecs
import sys
...
class Contact(genpy.Message):
  _md5sum = "092ef89bc484cc9b681ba742d6241a00"
  _type = "control_core_msgs/Contact"
...
float64 data"""
  __slots__ = ['pose','hull','offset','friction']
  _slot_types = ['geometry_msgs/Pose','geometry_msgs/Polygon','geometry_msgs/Point','std_msgs/Float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.friction is None:
        self.friction = std_msgs.msg.Float64()
    else:
      self.pose = geometry_msgs.msg.Pose()
      self.hull = geometry_msgs.msg.Polygon()
      self.offset = geometry_msgs.msg.Point()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_4d().pack(_x.offset.x, _x.offset.y, _x.offset.z, _x.friction.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.offset.x, _x.offset.y, _x.offset.z, _x.friction.data,) = _get_struct_4d().unpack(str[start:end])
      return self
