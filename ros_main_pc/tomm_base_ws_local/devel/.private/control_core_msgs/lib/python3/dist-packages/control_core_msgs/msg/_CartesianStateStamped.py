...
class CartesianStateStamped(genpy.Message):
  _md5sum = "71d3f1a6cffc25d5a82694e0e11f74a0"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_19d().pack(_x.state.position.position.x, _x.state.position.position.y, _x.state.position.position.z, _x.state.position.orientation.x, _x.state.position.orientation.y, _x.state.position.orientation.z, _x.state.position.orientation.w, _x.state.velocity.linear.x, _x.state.velocity.linear.y, _x.state.velocity.linear.z, _x.state.velocity.angular.x, _x.state.velocity.angular.y, _x.state.velocity.angular.z, _x.state.acceleration.linear.x, _x.state.acceleration.linear.y, _x.state.acceleration.linear.z, _x.state.acceleration.angular.x, _x.state.acceleration.angular.y, _x.state.acceleration.angular.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state.position.position.x, _x.state.position.position.y, _x.state.position.position.z, _x.state.position.orientation.x, _x.state.position.orientation.y, _x.state.position.orientation.z, _x.state.position.orientation.w, _x.state.velocity.linear.x, _x.state.velocity.linear.y, _x.state.velocity.linear.z, _x.state.velocity.angular.x, _x.state.velocity.angular.y, _x.state.velocity.angular.z, _x.state.acceleration.linear.x, _x.state.acceleration.linear.y, _x.state.acceleration.linear.z, _x.state.acceleration.angular.x, _x.state.acceleration.angular.y, _x.state.acceleration.angular.z,) = _get_struct_19d().unpack(str[start:end])
      return self
