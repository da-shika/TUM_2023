...
param_description = [{'name': 'active_distance', 'type': 'double', 'default': None, 'level': 0, 'edit_method': '""', 'description': '', 'min': None, 'max': None, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'cluster_tolerance', 'type': 'double', 'default': 0.03, 'level': 0, 'edit_method': '""', 'description': '', 'min': None, 'max': None, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'cluster_min_size', 'type': 'double', 'default': 3, 'level': 0, 'edit_method': '""', 'description': '', 'min': None, 'max': None, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'cluster_max_size', 'type': 'double', 'default': 100, 'level': 0, 'edit_method': '""', 'description': '', 'min': None, 'max': None, 'is_vector': False, 'is_eigen': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'masked_patches', 'type': 'std::vector<std::string>', 'default': [''], 'level': 0, 'edit_method': '""', 'description': '', 'min': None, 'max': None, 'is_vector': True, 'is_eigen': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False}]
...
class SkinContactGeneratorParameters(dict):
    def __init__(self):
