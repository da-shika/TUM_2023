...
"""autogenerated by genpy from ics_tsid_task_msgs/SkinForceConstraint.msg. Do not edit."""
import codecs
import sys
...
class SkinForceConstraint(genpy.Message):
  _md5sum = "997ea5adb62ebb597e70c90a3e090602"
  _type = "ics_tsid_task_msgs/SkinForceConstraint"
...
float64[] data"""
  __slots__ = ['dur','num_active_ieq','num_violated_ieq','max_force','min_distance','max_proximity','cell_nums','forces','vel_cmds','acc_limits','weight','a_relaxed']
  _slot_types = ['std_msgs/Int64','std_msgs/Int32','std_msgs/Int32','std_msgs/Float64','std_msgs/Float64','std_msgs/Float64','control_core_msgs/Vector','control_core_msgs/Vector','control_core_msgs/Vector','control_core_msgs/Vector','std_msgs/Float64','control_core_msgs/Vector']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       dur,num_active_ieq,num_violated_ieq,max_force,min_distance,max_proximity,cell_nums,forces,vel_cmds,acc_limits,weight,a_relaxed
    ...
    """
    if args or kwds:
      super(SkinForceConstraint, self).__init__(*args, **kwds)
      ...
      if self.forces is None:
        self.forces = control_core_msgs.msg.Vector()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_q2i3d().pack(_x.dur.data, _x.num_active_ieq.data, _x.num_violated_ieq.data, _x.max_force.data, _x.min_distance.data, _x.max_proximity.data))
      length = len(self.cell_nums.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.cell_nums.data))
      length = len(self.forces.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.forces.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.dur.data, _x.num_active_ieq.data, _x.num_violated_ieq.data, _x.max_force.data, _x.min_distance.data, _x.max_proximity.data,) = _get_struct_q2i3d().unpack(str[start:end])
      start = end
      end += 4
      ...
      self.forces.data = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.forces.data.tostring())
      length = len(self.vel_cmds.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.forces.data = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
...
def _get_struct_d():
    ...
    return _struct_d
_struct_q2i3d = None
def _get_struct_q2i3d():
    global _struct_q2i3d
    if _struct_q2i3d is None:
        _struct_q2i3d = struct.Struct("<q2i3d")
    return _struct_q2i3d
