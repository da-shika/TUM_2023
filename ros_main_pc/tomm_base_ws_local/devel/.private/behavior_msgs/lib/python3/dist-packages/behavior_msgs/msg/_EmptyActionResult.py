...
"""autogenerated by genpy from behavior_msgs/EmptyActionResult.msg. Do not edit."""
import codecs
import sys
...
class EmptyActionResult(genpy.Message):
  ...
  _type = "behavior_msgs/EmptyActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','behavior_msgs/EmptyResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = behavior_msgs.msg.EmptyResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = behavior_msgs.msg.EmptyResult()
