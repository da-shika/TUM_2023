...
"""
Track VIVE wrist_pos and wrist_rot
Right hand only
"""
...
class PR2ViveControll:
    ...
    def config(self):
        ...
        self.right_initial_position = np.array([-0.07581488381174972, 0.8761407701032226, 0.0019486110961992598,
                                                -2.0018626038496796, -3.11078091870049, -0.9786895437857286, -3.072562209162272])
