...
"""
Move by moveit_commander.excute
"""
...
class MovePR2Arm:
    ...
    def computeIK(self, time):
        ...
        self.arm_group.set_joint_value_target(self.righ_arm_joint_positions)

        right_hand_plan = self.arm_group.plan()
        self.arm_group.execute(right_hand_plan)
