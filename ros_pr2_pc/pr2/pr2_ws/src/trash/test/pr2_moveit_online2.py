...
class MovePR2Arm:
    ...
    def computeIK(self, time):
        ...
        self.joint_trajectory_goal.trajectory.joint_names = self.right_arm_joint_names
    ...
    def pub_joint_trajectory(self, joint_positions, duration=0.1):
        ...
        self.joint_trajectory_goal.trajectory.points.append(point)

        self.client.send_goal(self.joint_trajectory_goal)
